...
/**
* @card.h
* Declaração das cartas, seus respectivos nomes, naipes
*/
...
class card{
    ...
    public:
        card(int v,int s);
    /**
      * Construtor, onde v é o valor da carta, ou seja, A, rei, 4, etc. 
      * S é o naipe da carta, por exemplo, ouros ou espadas
    */ 
        string get_suit();
        int get_valor();
        string get_nome();
