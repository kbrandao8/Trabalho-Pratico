...
O jogo foi programado em c++, para ter o prompt de comando, ou o Windows PowerShell. Foi construído com base nas regras do truco mineiro, sendo este sempre de 4 jogadores podendo ser:
...
### Documentação: ###
Os arquivos html e Latex apresentam a documentação gerada pelo Doxygen.

### Como compilar: ##
É necessário baixar todos os arquivos presentes nesse repositório em uma mesma pasta e fazer o seguinte comando no cmd ou terminal utilizado:
...
##### Funções:
###### Atualizar:
Atualiza a mão de todos os jogadores com novas cartas quando chamada.
...
- Uma pessoa que gosta de jogar truco usa o jogo para melhorar suas habilidades. 

- Um estudante no intervalo da aula usa o jogo para sua distração.

- Um jogador usa o jogo para praticar e participar do tradicional Campenato de Truco na Engenharia Mecânica. 

- Um grupo de amigos usa o software para diversão em grupo.

- Dois amigos querem jogar truco porém não tem a quantidade de pessoas ideal (4) usa o jogo com bots. 

- Um jogador semi-profissional usa o jogo para praticar suas habilidades.
